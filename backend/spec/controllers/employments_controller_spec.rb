...
RSpec.describe EmploymentsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: employment.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      employment = Employment.create! valid_attributes
      get :edit, params: {id: employment.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Employment" do
        expect {
          post :create, params: {employment: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {employment: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested employment" do
        employment = Employment.create! valid_attributes
        put :update, params: {id: employment.to_param, employment: new_attributes}, session: valid_session
        employment.reload
      ...
      it "redirects to the employment" do
        employment = Employment.create! valid_attributes
        put :update, params: {id: employment.to_param, employment: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        employment = Employment.create! valid_attributes
        put :update, params: {id: employment.to_param, employment: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested employment" do
      employment = Employment.create! valid_attributes
      expect {
        delete :destroy, params: {id: employment.to_param}, session: valid_session
      }.to change(Employment, :count).by(-1)
    end
